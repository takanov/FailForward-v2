...
RUN apt-get update -qq &&     apt-get install --no-install-recommends -y build-essential git libpq-dev libyaml-dev pkg-config postgresql-client &&     rm -rf /var/lib/apt/lists /var/cache/apt/archives
